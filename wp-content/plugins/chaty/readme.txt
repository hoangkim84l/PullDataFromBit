...
5. Remove the "Get Chaty" link on the chat button
6. Show (or don't show) the chat widget using targeting rules such as specific pages, pages that contain a string, and pages that start or end with a string
